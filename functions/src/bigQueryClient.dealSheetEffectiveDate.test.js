...
test("dealSheetEffectiveDateFromTentative: TENTATIVE_DATE + 1 (matches ownership, not extension START)", () => {
  // Gabriel Tamayo case: TENTATIVE_DATE=2026-10-17 → ownership EFFECTIVE_DATE=2026-10-18.
...
test("applyPreviousRecruiterOnRecruiterChange: stamps EFFECTIVE_DATE = TENTATIVE_DATE + 1 (Gabriel-style)", () => {
  ...
  assert.equal(row.EFFECTIVE_DATE, "2026-10-18");
});
